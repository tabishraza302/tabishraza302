...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=13&duration=1800&pause=900&color=00FF88&center=true&vCenter=true&multiline=true&repeat=false&width=520&height=80&lines=ssh+tabishraza302%40github.com;Connection+established.+Welcome.;tabish%40github%3A~%24+_" alt="terminal" />
...
```
tabish@github:~$ ls -la builds/

   drwxr-xr-x   hearhelp/        [ACTIVE]   end-to-end hearing care platform
   drwxr-xr-x   securescan/      [LAB]      real-time website threat detection
   drwxr-xr-x   dualsentinel/    [LAB]      offensive + defensive security tooling
```
...
tabish@github:~$ cat builds/*/README
   ...
   │  repo   ▸  github.com/tabishraza302/SecureScan                             │
   │                                                                            │
   └────────────────────────────────────────────────────────────────────────────┘
   ...
   │                                                                            │
   │  stack  ▸  Python · Scapy · Security Tooling · Network Analysis            │
   │  org    ▸  github.com/DualSentinel                                         │
   │                                                                            │
   └────────────────────────────────────────────────────────────────────────────┘
```
